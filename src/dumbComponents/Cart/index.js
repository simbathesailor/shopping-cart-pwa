...
class Cart extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
      <div className="cart" onClick={this.changeVisibilityList}></div>
      ...
      {isVisibleList &&
        ...
        <ul className="list-container">
          {
            cartItems && Object.keys(cartItems).map((id) => {
              ...
              return (
                <li 
                  key={sku} className="item-row"
                  draggable
                  onDragStart={ev => this.drag(ev, item)}

                >
                  <img className="img-it-row" src={p_img_url} alt="itemimg"/>
                  ...
                  <div className="remove" onClick={() => {this.onClickCross(sku)}}>
                    X
                  </div>
                </li>
              )
        ...
        <div className="total-section">
          <div className="sub-total">
            Sub Total: Rs {cartTotal}
          </div>
          <button className="checkout-btn" onClick={this.goToCheckout}>View Basket & Checkout</button>
        </div>
      </div>
       }
      </div>
